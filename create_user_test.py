...
def test_create_user_2_letter_in_first_name_get_success_response():
    ...
    user_response = test_sender_stand_request.post_new_user(user_body)
...
def test_create_user_2_letter_in_first_name_get_success_response():
    ...
    users_table_response = test_sender_stand_request.get_users_table()
...
def negative_assert_symbol(first_name):
    ...
    response = test_sender_stand_request.post_new_user(user_body)
